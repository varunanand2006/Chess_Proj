...
class Board:
    def __init__(self):
        ...
        self.QrookMoved = False
        self.KrookMoved = False
    ...
    # Returns true if square is attacked by a piece of color "by_color"
    ...
    # Returns list of all legal moves for a single piece
    ...
    def is_in_check(self, color):
        ...
        # Return if the King is being attacked by an enemy piece
